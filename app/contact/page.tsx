              ...
              <CardContent className="space-y-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">info@smartzglobal.com</p>
                    <p className="text-muted-foreground">support@smartzglobal.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">123 Technology Street</p>
            ...
            <Card>
              ...
              <CardContent>
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-lg">Eneji Daniel Moses</h3>
                    <p className="text-muted-foreground">Chief Executive Officer</p>
                    <p className="text-sm text-muted-foreground mt-1">
                      Leading Sm@rtz Global Enterprise with vision and innovation
                    </p>
                  </div>
                </div>
              </CardContent>
